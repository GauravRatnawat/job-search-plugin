...
### Step 4b: Save Combined Report

After displaying the list, write a combined markdown report to `.cache/<persona>/job-report.md`.

**File structure:**

```markdown
> Generated: [YYYY-MM-DD] | Persona: [persona-slug]
...
**Top Skills:** [comma-separated top 8 skills]
**Target Roles:** [comma-separated recommended roles]
...
### 🟢 High Probability (70+) — Apply now
| # | Role | Company | Location | Type | Score | Link |
|---|------|---------|----------|------|-------|------|
| 1 | ... | ... | ... | ... | 85/100 | [Apply](...) |

### 🟡 Medium Probability (55–69) — Tailor resume first
| # | Role | Company | Location | Type | Score | Link |
...

### 🔴 Stretch (40–54) — Aspirational
| # | Role | Company | Location | Type | Score | Link |
...

---
*Report generated by job-search-mcp. Rerun /input-resume to refresh.*
```

After writing the file, tell the user:
```
📄 Full report saved to `.cache/[persona]/job-report.md` — open in VS Code or any markdown viewer.
```
